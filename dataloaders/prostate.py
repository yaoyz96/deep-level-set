...
class Prostate(Dataset):
    ...
    def __init__(self, train=True, split='train',
                 db_root_dir=Path.db_root_dir('prostate'),
                 transform=None,
                 retname=True):
...
if __name__ == '__main__':
    ...
    dataset = Prostate(train=True, split='train', transform=transforms)
